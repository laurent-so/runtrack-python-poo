class Voiture:
    ...
    def __str__(self):
        return f"Voiture {self.__marque} {self.__modele} ({self.__annee}) - {self.__kilometrage} km"

voiture1 = Voiture("Peugeot", "307", 2009, 120000)
print(voiture1.get_marque()) 
print(voiture1.get_modele()) 
print(voiture1.get_annee()) 
print(voiture1.get_kilometrage()) 
print(voiture1.get_en_marche()) 

voiture1.ajouter_essence(10)
voiture1.demarrer()
print(voiture1.get_en_marche()) 
